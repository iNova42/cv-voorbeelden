Python/vacature.py# -*- coding: utf-8 -*-
...
def main():
	try:
		...
		low_priority_locationList = ["BERLARE", "BUGGENHOUT", "DESTELBERGEN", "DESTELDONK", "ERPE-MERE", "ERTVELDE", "EVERGEM", "GIJZEGEM", "HAMME", "HERDERSEM", "HEUSDEN", "KALKEN", "LAARNE", "LEDE", "LEBBEKE", "MELLE", "MELSELE", "MERELBEKE", "MOORSEL", "NIEUWERKERKEN", "OOSTAKKER", "OPWIJK", "SCHOONAARDE", "SERSKAMP", "SINT-AMANDS", "SINT-GILLIS-WAAS", "SINT-KRUIS-WINKEL", "SINT-PAUWELS", "VRASENE", "WAASMUNSTER", "WACHTEBEKE", "WETTEREN", "WICHELEN", "WIEZE", "ZELZATE"]
		...
		for i in range(20):
			...
			for job_title in job_title_html_List:
				...
				"""
						Checks if the vacature is in an low_priority region, adding it to exclusions list
				"""
				
				if(doubleID == False):
					for location in low_priority_locationList:
